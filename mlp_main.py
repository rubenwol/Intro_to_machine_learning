...
if __name__ == "__main__":
    main()
    # train_eval_series(hidden_layers=[[10], [10, 16], [10, 16, 22], [10, 16, 22, 28], [10, 16, 22, 28, 34]], skips=1,
    #                   epochs=50, batch_size=32, output_curve="b")
    arr = []
    for i in range(60):
        arr.append(16)
    train_eval_single(hidden_layers=arr,skips=1,epochs=80,batch_size=32,output_curve='c')
    train_eval_single(hidden_layers=arr, skips=5, epochs=80, batch_size=32,output_curve='d')
